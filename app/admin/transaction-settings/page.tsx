...
export default function TransactionSettingsPage() {
  ...
  return (
    <div className="p-8 max-w-2xl mx-auto">
      <h1 className="text-2xl font-bold mb-6">⚙️ Paramètres transaction</h1>
      ...
      <div className="bg-white rounded-xl shadow p-6 space-y-4">
        <div>
          ...
          />
          <p className="text-xs text-gray-500">Pourcentage prélevé sur chaque vente (vendeur)</p>
        </div>
        ...
        <div>
          ...
          <input
            ...
            className="w-full p-2 border rounded"
          />
          <p className="text-xs text-gray-500">Utilisé pour affichage, n'affecte pas le calcul</p>
        </div>
