    ...
    <div className="min-h-screen bg-gray-50 flex items-center justify-center p-4">
      <div className="max-w-md w-full bg-white rounded-2xl shadow-lg p-6 text-center">
        ...
        <div className="mt-6 text-sm text-gray-500">
          <Link href="/auth/login" className="text-green-600 hover:underline">← Retour à la connexion</Link>
        </div>
        <p className="text-xs text-gray-400 mt-6">
          Vous avez déjà confirmé votre email ?{' '}
          <Link href="/auth/login" className="text-green-600 hover:underline">Connectez-vous</Link>
        </p>
      </div>
    </div>
  );
